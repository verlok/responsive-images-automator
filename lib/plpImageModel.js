...
const plpCompareFn = (rowA, rowB) => rowA.viewportWidth - rowB.viewportWidth || rowA.pixelRatio - rowB.pixelRatio;
...
export default (intrinsicWidthsConfig, pxrCap) => {
    const sortedWidthConfig = intrinsicWidthsConfig.sort(plpCompareFn);
